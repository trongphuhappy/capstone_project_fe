...
//           <div
//             className={`h-[45px] px-4 rounded-md flex items-center mb-1 ${nav === index && "bg-[#00939f]"
//               }`}
//           >
//             <span
//               className={`text-[15px] ${nav === index ? "text-white" : "text-black"
//                 }`}
//             >
//               {item.name}
//             </span>
...
//         <div className="max-w-[1425px] h-[530px] mx-auto overflow-hidden">
